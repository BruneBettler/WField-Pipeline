...
import tqdm
import glob
from PIPELINE.pipeline_utils import normalize_arr
...
from PIPELINE.GUIs.draw_gui import * 
from datetime import timedelta
from PIPELINE.data_extractor import *
import matplotlib.pyplot as plt
from scipy.signal import butter, filtfilt, sosfiltfilt
import datetime
from scipy import stats
from PIPELINE.exploration_utils import load_dat_analog


'''
processing.py contains all functions necessary to run a modular processing pipeline/workflow for a single or series of experiemnts. 
